...
pathFrame_all = 'Data/all'
pathFrame_resize = 'Data/resize'

pathFrame_lakemary = 'Data/lakemary'
pathFrame_resize_lakemary = 'Data/resize_lakemary'

pathFrame_test = 'Data/Test_frame/'
pathFrame_resize_test = 'Data/Test/'
