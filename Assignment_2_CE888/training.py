...
def train_keras():
    ...
    dir_fire = 'Data/Training/Fire/'
    dir_no_fire = 'Data/Training/No_Fire/'
    ...
    train_ds = tf.keras.preprocessing.image_dataset_from_directory(
        "Data/Training", validation_split=0.2, subset="training", seed=1337, image_size=image_size,
        batch_size=batch_size, shuffle=True
    )

    val_ds = tf.keras.preprocessing.image_dataset_from_directory(
        "Data/Training", validation_split=0.2, subset="validation", seed=1337, image_size=image_size,
        batch_size=batch_size, shuffle=True
    )
    ...
    img = keras.preprocessing.image.load_img(
        "Data/Training/Fire/resized_frame1801.jpg", target_size=image_size)
